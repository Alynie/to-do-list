...
const TodoList: React.FC<TodoListProps> = () => {
  ...
  if (tasks.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-10 text-gray-500">
        ...
        >
          <path
            fill="#F9A926"
            d="M497.012,292.953c-19.478-19.59-51.31-19.59-70.788,0c-19.478,19.478-19.478,51.311,0,70.79
	...
	C480.105,323.239,479.797,333.768,473.465,340.059z"
          ...
          <path
            fill="#FFC033"
            d="M333.54,324.119l-11.13,11.13L193.853,463.694c-9.682,9.795-22.595,14.692-35.394,14.692
	...
	L333.54,324.119z"
          ...
          <path
            fill="#F26D76"
            d="M368.935,288.613l-35.394,35.506l-70.79-70.79l-70.901-70.901l35.394-35.395
	c6.568-6.567,17.141-6.567,23.598,0l59.101,58.991l58.99,58.991C375.503,271.583,375.503,282.156,368.935,288.613z"
          />
          <path
            fill="#D7EBFF"
            d="M134.974,444.327c-6.901,20.48-25.934,34.282-47.527,34.282H50.383
	...
	c7.123,0,13.579-4.563,15.805-11.464c2.894-8.682,12.354-13.468,21.147-10.463C133.081,426.184,137.867,435.645,134.974,444.327z"
          ...
          <path
            fill="#E65C64"
            d="M368.935,288.613l-35.394,35.506l-70.79-70.79l47.193-47.304l58.99,58.991
	C375.503,271.583,375.503,282.156,368.935,288.613z"
          />
          <path
            fill="#F9A926"
            d="M333.54,324.119L193.853,463.694c-9.682,9.795-22.595,14.692-35.394,14.692
	c-12.8,0-25.6-4.897-35.394-14.692L87.67,428.299l164.063-163.951l11.019-11.019L333.54,324.119z"
          />
          <path
            fill="#FFC033"
            d="M345.337,187.288c-4.272,0-8.544-1.631-11.804-4.892c-6.521-6.516-6.521-17.087,0-23.609
	...
	C353.88,185.658,349.608,187.288,345.337,187.288z"
          ...
          <path
            fill="#E65C64"
            d="M489.5,231.316c-3.369,0-6.761-1.011-9.707-3.12c-26.923-19.256-62-22.044-91.571-7.25
	...
	c7.5,5.364,9.228,15.793,3.859,23.294C499.826,228.892,494.696,231.316,489.5,231.316z"
          ...
          <path
            fill="#F26D76"
            d="M309.929,151.876c-1.457,0-2.935-0.19-4.402-0.592c-8.897-2.43-14.141-11.603-11.717-20.5
	...
	c26.946,37.277,35.456,84.098,23.358,128.467C324,146.995,317.272,151.876,309.929,151.876z"
          />
          <circle fill="#36D9D9;" cx="383.744" cy="38.734" r="16.696" />
          <circle fill="#43BFBF;" cx="472.788" cy="138.908" r="16.696" />
          <rect
            x="175.271"
            y="307.423"
            fill="#36D9D9;"
          ...
          <path
            fill="#F9A926;"
            d="M333.557,182.413c3.258,3.247,7.516,4.875,11.779,4.875c4.272,0,8.544-1.631,11.804-4.892
	L498.803,40.728c6.514-6.514,6.515-17.064,0.018-23.582L333.557,182.413z"
          />
          <polygon
            fill="#43BFBF;"
            points="208.658,307.424 208.658,340.815 175.267,340.815 "
          />
          <path
            fill="#FFC033;"
            d="M213.186,14.692c-19.478-19.59-51.31-19.59-70.788,0c-19.478,19.478-19.478,51.311,0,70.79
